...
# def create_overlap_mask(image_path, scaled_boxes, overlap_threshold):
...
#     mask_count = np.zeros(image_shape, dtype=np.uint8)
...
# def process_files(image_path, csv_folder_path, scales, overlap_thresholds):
...
#                 mask = create_overlap_mask(image_path, scaled_boxes, overlap_threshold)
                
#                 # Create the output directory if it doesn't exist
#                 # output_dir = f'overlapping_masks/{scale}-scale/'
...
# # Example usage
# image_path = 'extracted_bg/4701-bg.jpg'  # Path to your image file
# csv_folder_path = 'centroidsv2/'  # Folder containing your CSV files

# # scales = [0.3, 0.35, 0.4, 0.45, 0.5]  # Array of scales to test
# scales = [0.35, 0.4]  # Array of scales to test

# # overlap_thresholds = [4, 5 , 6, 7, 8 , 9 , 10, 11, 12]  # Array of overlap thresholds to test
# overlap_thresholds = [8 , 9 , 10]  # Array of overlap thresholds to test


# process_files(image_path, csv_folder_path, scales, overlap_thresholds)
import numpy as np
import pandas as pd
import cv2
import os
